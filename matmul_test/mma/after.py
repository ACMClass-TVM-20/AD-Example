...
class Module:
    ...
    def fused_fused_relax_permute_dims_relax_matmul_cast(B: T.Buffer((T.int64(4096), T.int64(4096)), "float16"), A: T.Buffer((T.int64(4), T.int64(512), T.int64(4096)), "float16"), var_compute_intermediate: T.Buffer((T.int64(4), T.int64(512), T.int64(4096)), "float16")):
        ...
        p_output0_intermediate_reindex_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(2048), T.int64(4096)), scope="shared.dyn")
        p_output0_intermediate_reindex_shared_dyn_warp = T.alloc_buffer((T.int64(128), T.int64(256), T.int64(32), T.int64(8)), scope="warp")
    ...
    def main(A: R.Tensor((4, 512, 4096), dtype="float16"), B: R.Tensor((4096, 4096), dtype="float16")) -> R.Tensor((4, 512, 4096), dtype="float16"):
        cls = Module
        with R.dataflow():
            gv = R.call_tir(cls.fused_fused_relax_permute_dims_relax_matmul_cast, (B, A), out_sinfo=R.Tensor((4, 512, 4096), dtype="float16"))
            R.output(gv)
        return gv
