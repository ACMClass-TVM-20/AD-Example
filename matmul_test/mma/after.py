...
class Module:
    ...
    def fused_matmul_cast(A: T.Buffer((T.int64(4), T.int64(511), T.int64(4096)), "float16"), B: T.Buffer((T.int64(4096), T.int64(4094)), "float16"), var_compute_intermediate: T.Buffer((T.int64(4), T.int64(511), T.int64(4094)), "float16")):
        ...
        # with T.block("root"):
        A_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(2048), T.int64(4096)), "float16", scope="shared.dyn")
        A_reindex_pad_shared_dyn_warp = T.alloc_buffer((T.int64(1), T.int64(128), T.int64(256), T.int64(32), T.int64(8)), "float16", scope="warp")
        B_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(4096), T.int64(4096)), "float16", scope="shared.dyn")
        B_reindex_pad_shared_dyn_warp = T.alloc_buffer((T.int64(1), T.int64(256), T.int64(256), T.int64(32), T.int64(8)), "float16", scope="warp")
        var_matmul_intermediate_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(2048), T.int64(4096)), scope="shared.dyn")
        var_matmul_intermediate_reindex_pad_shared_dyn_warp = T.alloc_buffer((T.int64(1), T.int64(128), T.int64(256), T.int64(32), T.int64(8)), scope="warp")
        for ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused in T.thread_binding(T.int64(512), thread="blockIdx.x"):
                ...
                for ax2_0_2_init in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                    for ax1_0_3_init, ax2_0_3_init in T.grid(T.int64(4), T.int64(4)):
                        with T.block("matmul_o_init"):
                            ...
                            v1_o = T.axis.spatial(T.int64(128), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused // T.int64(32) * T.int64(8) + ax1_0_2_init * T.int64(4) + ax1_0_3_init)
                            ...
                            T.reads()
                            T.writes(var_matmul_intermediate_reindex_pad_shared_dyn_warp[T.int64(0), v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                            with T.block("matmul_init_o"):
                                v1_i_init_o = T.axis.spatial(T.int64(1), T.int64(0))
                                v2_i_init_o = T.axis.spatial(T.int64(1), T.int64(0))
                                T.reads()
                                T.writes(var_matmul_intermediate_reindex_pad_shared_dyn_warp[T.int64(0), v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                C_warp = T.match_buffer(var_matmul_intermediate_reindex_pad_shared_dyn_warp[T.int64(0), v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), scope="warp", offset_factor=1)
                            ...
                            for ax0_ax1_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_4 in T.vectorized(T.int64(4)):
                                    with T.block("A_reindex_pad_shared.dyn"):
                                        ...
                                        v1 = T.axis.spatial(T.int64(2048), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused // T.int64(32) * T.int64(128) + (ax0_ax1_fused_0 * T.int64(512) + ax0_ax1_fused_1 * T.int64(256) + ax0_ax1_fused_2 * T.int64(128) + ax0_ax1_fused_3 * T.int64(4) + ax0_ax1_fused_4) // T.int64(32))
                                        ...
                                        T.reads(A[v1 // T.int64(511), v1 % T.int64(511), v2])
                                        T.writes(A_reindex_pad_shared_dyn[v0, v1, v2])
                                        T.block_attr({"permuted_layout": "g2s_A"})
                                        A_reindex_pad_shared_dyn[v0, v1, v2] = T.if_then_else(v1 < T.int64(2044), A[v1 // T.int64(511), v1 % T.int64(511), v2], T.float16(0))
                for ax0_ax1_fused_0 in range(T.int64(8)):
                    for ax0_ax1_fused_1 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                        for ax0_ax1_fused_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                            for ax0_ax1_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_4 in T.vectorized(T.int64(4)):
                                    with T.block("B_reindex_pad_shared.dyn"):
                                        v0 = T.axis.spatial(T.int64(1), T.int64(0))
                                        v1 = T.axis.spatial(T.int64(4096), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused % T.int64(32) * T.int64(128) + (ax0_ax1_fused_0 * T.int64(512) + ax0_ax1_fused_1 * T.int64(256) + ax0_ax1_fused_2 * T.int64(128) + ax0_ax1_fused_3 * T.int64(4) + ax0_ax1_fused_4) // T.int64(32))
                                        v2 = T.axis.spatial(T.int64(4096), ax3_0_0 * T.int64(32) + (ax0_ax1_fused_0 * T.int64(512) + ax0_ax1_fused_1 * T.int64(256) + ax0_ax1_fused_2 * T.int64(128) + ax0_ax1_fused_3 * T.int64(4) + ax0_ax1_fused_4) % T.int64(32))
                                        T.reads(B[v2, v1])
                                        T.writes(B_reindex_pad_shared_dyn[v0, v1, v2])
                                        T.block_attr({"permuted_layout": "g2s_B"})
                                        B_reindex_pad_shared_dyn[v0, v1, v2] = T.if_then_else(v1 < T.int64(4094), B[v2, v1], T.float16(0))
                        ...
                        for ax3_0_1 in range(T.int64(2)):
                            for ax0_0 in range(T.int64(4)):
                                with T.block("A_reindex_pad_shared.dyn_warp_o"):
                                    v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                    v1_o = T.axis.spatial(T.int64(128), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused // T.int64(32) * T.int64(8) + ax1_0_2 * T.int64(4) + ax0_0)
                            ...
                            for ax0_0 in range(T.int64(4)):
                                with T.block("B_reindex_pad_shared.dyn_warp_o"):
                                    v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                    ...
                                    T.writes(B_reindex_pad_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                    ...
                                    with T.block("B_reindex_pad_shared.dyn_warp_o"):
                                        ...
                                        T.reads(B_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                        T.writes(B_reindex_pad_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                        warp = T.match_buffer(B_reindex_pad_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), "float16", scope="warp", offset_factor=16)
                                        shared = T.match_buffer(B_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("shared_s0", "shared_s1"), scope="shared.dyn", offset_factor=16)
                                        for tx in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                            ...
                            for ax1_0_3, ax2_0_3 in T.grid(T.int64(4), T.int64(4)):
                                with T.block("matmul_o_update"):
                                    v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                    v1_o = T.axis.spatial(T.int64(128), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused // T.int64(32) * T.int64(8) + ax1_0_2 * T.int64(4) + ax1_0_3)
                                    ...
                                    T.reads(var_matmul_intermediate_reindex_pad_shared_dyn_warp[T.int64(0), v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], A_reindex_pad_shared_dyn_warp[T.int64(0), v1_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], B_reindex_pad_shared_dyn_warp[T.int64(0), v2_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                    T.writes(var_matmul_intermediate_reindex_pad_shared_dyn_warp[T.int64(0), v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                    with T.block("matmul_o"):
                                        ...
                                        B_1 = T.match_buffer(B_reindex_pad_shared_dyn_warp[T.int64(0), v2_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), "float16", scope="warp", offset_factor=16)
                                        C = T.match_buffer(var_matmul_intermediate_reindex_pad_shared_dyn_warp[T.int64(0), v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), scope="warp", offset_factor=8)
                                        for tx in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                ...
                for ax1_0 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                    for ax2_0 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                        for ax1_1, ax2_1 in T.grid(T.int64(4), T.int64(4)):
                            with T.block("var_matmul_intermediate_reindex_pad_shared.dyn_warp_o"):
                                v0_o = T.axis.spatial(T.int64(1), ax0)
                                v1_o = T.axis.spatial(T.int64(128), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused // T.int64(32) * T.int64(8) + ax1_0 * T.int64(4) + ax1_1)
                                v2_o = T.axis.spatial(T.int64(256), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused % T.int64(32) * T.int64(8) + ax2_0 * T.int64(4) + ax2_1)
                                T.reads(var_matmul_intermediate_reindex_pad_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                T.writes(var_matmul_intermediate_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                ...
                                with T.block("var_matmul_intermediate_reindex_pad_shared.dyn_warp_o"):
                                    ...
                                    T.reads(var_matmul_intermediate_reindex_pad_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                    T.writes(var_matmul_intermediate_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                    C_warp = T.match_buffer(var_matmul_intermediate_reindex_pad_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), scope="warp", offset_factor=1)
                                    C = T.match_buffer(var_matmul_intermediate_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), strides=("C_s0", "C_s1"), scope="shared.dyn", offset_factor=1)
                                    for tx in T.thread_binding(T.int64(32), thread="threadIdx.x"):
            ...
            for ax0_ax1_fused_0 in range(T.int64(32)):
                for ax0_ax1_fused_1 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                    for ax0_ax1_fused_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                        for ax0_ax1_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                            for ax0_ax1_fused_4 in T.vectorized(T.int64(4)):
                                with T.block("var_matmul_intermediate_reindex_pad_shared.dyn"):
                                    v0 = T.axis.spatial(T.int64(1), T.int64(0))
                                    v1 = T.axis.spatial(T.int64(2048), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused // T.int64(32) * T.int64(128) + (ax0_ax1_fused_0 * T.int64(512) + ax0_ax1_fused_1 * T.int64(256) + ax0_ax1_fused_2 * T.int64(128) + ax0_ax1_fused_3 * T.int64(4) + ax0_ax1_fused_4) // T.int64(128))
                                    v2 = T.axis.spatial(T.int64(4096), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused % T.int64(32) * T.int64(128) + (ax0_ax1_fused_0 * T.int64(512) + ax0_ax1_fused_1 * T.int64(256) + ax0_ax1_fused_2 * T.int64(128) + ax0_ax1_fused_3 * T.int64(4) + ax0_ax1_fused_4) % T.int64(128))
                                    T.reads(var_matmul_intermediate_reindex_pad_shared_dyn[v0, v1, v2])
                                    T.writes(var_compute_intermediate[v1 // T.int64(511), v1 % T.int64(511), v2])
                                    T.block_attr({"permuted_layout": "s2g_C"})
                                    if v1 < T.int64(2044) and v2 < T.int64(4094):
                                        var_compute_intermediate[v1 // T.int64(511), v1 % T.int64(511), v2] = T.Cast("float16", var_matmul_intermediate_reindex_pad_shared_dyn[v0, v1, v2])
