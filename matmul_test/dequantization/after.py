...
class Module:
    ...
    def fused_fused_dequantize_fused_relax_permute_dims_relax_matmul_cast(weight: T.Buffer((T.int64(4096), T.int64(512)), "uint32"), scale: T.Buffer((T.int64(4096), T.int64(128)), "float16"), A: T.Buffer((T.int64(1), T.int64(4094), T.int64(4096)), "float16"), var_compute_intermediate: T.Buffer((T.int64(1), T.int64(4094), T.int64(4096)), "float16")):
        ...
        # with T.block("root"):
        A_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(4096), T.int64(4096)), "float16", scope="shared.dyn")
        A_reindex_pad_shared_dyn_warp = T.alloc_buffer((T.int64(256), T.int64(256), T.int64(32), T.int64(8)), "float16", scope="warp")
        var_T_transpose_intermediate_reindex_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(4096), T.int64(4096)), "float16", scope="shared.dyn")
        ...
        p_output0_intermediate_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(4096), T.int64(4096)), scope="shared.dyn")
        p_output0_intermediate_reindex_pad_shared_dyn_warp = T.alloc_buffer((T.int64(256), T.int64(256), T.int64(32), T.int64(8)), scope="warp")
                ...
                for ax2_0_2_init in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                    for ax1_0_3_init, ax2_0_3_init in T.grid(T.int64(4), T.int64(4)):
                        with T.block("matmul_o_init"):
                            ...
                            T.reads()
                            T.writes(p_output0_intermediate_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                            with T.block("matmul_init_o"):
                                v1_i_init_o = T.axis.spatial(T.int64(1), T.int64(0))
                                v2_i_init_o = T.axis.spatial(T.int64(1), T.int64(0))
                                T.reads()
                                T.writes(p_output0_intermediate_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                C_warp = T.match_buffer(p_output0_intermediate_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), scope="warp", offset_factor=1)
                            ...
                            for ax0_ax1_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_4 in T.vectorized(T.int64(8)):
                                    with T.block("A_reindex_pad_shared.dyn"):
                                        ...
                                        A_reindex_pad_shared_dyn[v0, v1, v2] = T.if_then_else(v1 < T.int64(4094), A[v0, v1, v2], T.float16(0))
                for ax0_ax1_fused_0 in range(T.int64(4)):
                    for ax0_ax1_fused_1 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                        for ax0_ax1_fused_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                            for ax0_ax1_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_4 in T.vectorized(T.int64(8)):
                                    with T.block("var_T_transpose_intermediate_reindex_shared.dyn"):
                                        ...
                                        v1 = T.axis.spatial(T.int64(4096), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused % T.int64(32) * T.int64(128) + (ax0_ax1_fused_0 * T.int64(1024) + ax0_ax1_fused_1 * T.int64(512) + ax0_ax1_fused_2 * T.int64(256) + ax0_ax1_fused_3 * T.int64(8) + ax0_ax1_fused_4) // T.int64(32))
                                        v2 = T.axis.spatial(T.int64(4096), ax3_0_0 * T.int64(32) + (ax0_ax1_fused_0 * T.int64(1024) + ax0_ax1_fused_1 * T.int64(512) + ax0_ax1_fused_2 * T.int64(256) + ax0_ax1_fused_3 * T.int64(8) + ax0_ax1_fused_4) % T.int64(32))
                                        T.reads(weight[v1, v2 // T.int64(8)], scale[v1, v2 // T.int64(32)])
                                        T.writes(var_T_transpose_intermediate_reindex_shared_dyn[v0, v1, v2])
                                        T.block_attr({"permuted_layout": "g2s_B"})
                                        var_T_transpose_intermediate_reindex_shared_dyn[v0, v1, v2] = (T.Cast("float16", T.bitwise_and(T.shift_right(weight[v1, v2 // T.int64(8)], T.Cast("uint32", v2 % T.int64(8)) * T.uint32(4)), T.uint32(15))) - T.float16(7)) * scale[v1, v2 // T.int64(32)]
                        ...
                        for ax3_0_1 in range(T.int64(2)):
                            for ax0_0 in range(T.int64(4)):
                                with T.block("A_reindex_pad_shared.dyn_warp_o"):
                                    ...
                                    T.writes(A_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                    ...
                                    with T.block("A_reindex_pad_shared.dyn_warp_o"):
                                        ...
                                        T.reads(A_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                        T.writes(A_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                        warp = T.match_buffer(A_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), "float16", scope="warp", offset_factor=16)
                            ...
                            for ax1_0_3, ax2_0_3 in T.grid(T.int64(4), T.int64(4)):
                                with T.block("matmul_o_update"):
                                    ...
                                    T.reads(p_output0_intermediate_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], A_reindex_pad_shared_dyn_warp[v1_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], var_T_transpose_intermediate_reindex_shared_dyn_warp[v2_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                    T.writes(p_output0_intermediate_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                    with T.block("matmul_o"):
                                        ...
                                        T.reads(p_output0_intermediate_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], A_reindex_pad_shared_dyn_warp[v1_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], var_T_transpose_intermediate_reindex_shared_dyn_warp[v2_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                        T.writes(p_output0_intermediate_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                        A_1 = T.match_buffer(A_reindex_pad_shared_dyn_warp[v1_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), "float16", scope="warp", offset_factor=16)
                                        B = T.match_buffer(var_T_transpose_intermediate_reindex_shared_dyn_warp[v2_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), "float16", scope="warp", offset_factor=16)
                                        C = T.match_buffer(p_output0_intermediate_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), scope="warp", offset_factor=8)
                                        for tx in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                    ...
                    for ax2_0 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                        for ax1_1, ax2_1 in T.grid(T.int64(4), T.int64(4)):
                            with T.block("p_output0_intermediate_reindex_pad_shared.dyn_warp_o"):
                                ...
                                T.reads(p_output0_intermediate_reindex_pad_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
