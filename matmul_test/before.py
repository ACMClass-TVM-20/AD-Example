...
class Module:
    ...
    def fused_fused_relax_permute_dims_relax_matmul_cast(B: T.Buffer((T.int64(11008), T.int64(4096)), "float16"), A: T.Buffer((T.int64(4), T.int64(512), T.int64(4096)), "float16"), var_compute_intermediate: T.Buffer((T.int64(4), T.int64(512), T.int64(11008)), "float16")):
        ...
        p_output0_intermediate = T.alloc_buffer((T.int64(4), T.int64(512), T.int64(11008)))
        ...
        for i0, i1, i2, k in T.grid(T.int64(4), T.int64(512), T.int64(11008), T.int64(4096)):
            with T.block("matmul"):
        ...
        for i0, i1, i2 in T.grid(T.int64(4), T.int64(512), T.int64(11008)):
