...
class Module:
    ...
    def fused_fused_relax_permute_dims_relax_matmul_cast(B: T.Buffer((T.int64(4096), T.int64(4096)), "float16"), A: T.Buffer((T.int64(1), T.int64(512), T.int64(4096)), "float16"), var_compute_intermediate: T.Buffer((T.int64(1), T.int64(512), T.int64(4096)), "float16")):
        T.func_attr({"tir.noalias": T.bool(True)})
        # with T.block("root"):
        var_T_transpose_intermediate = T.alloc_buffer((T.int64(4096), T.int64(4096)), "float16")
        p_output0_intermediate = T.alloc_buffer((T.int64(1), T.int64(512), T.int64(4096)))
        ...
        for i0, i1, i2, k in T.grid(T.int64(1), T.int64(512), T.int64(4096), T.int64(4096)):
            with T.block("matmul"):
        ...
        for i0, i1, i2 in T.grid(T.int64(1), T.int64(512), T.int64(4096)):
    ...
    @R.function
    def main(A: R.Tensor((1, 512, 4096), dtype="float16"), B: R.Tensor((4096, 4096), dtype="float16")) -> R.Tensor((1, 512, 4096), dtype="float16"):
        cls = Module
        with R.dataflow():
