...
class Module:
    ...
    def compute(B: T.Buffer((T.int64(4096), T.int64(4096)), "float16"), A: T.Buffer((T.int64(2048), T.int64(4096)), "float16"), O: T.Buffer((T.int64(2048), T.int64(4096)), "float16")):
        ...
        # for bx in T.thread_binding(T.int64(4096), thread="blockIdx.x"):
        for bx in T.thread_binding(T.int64(4096), thread="blockIdx.x", annotations={"pragma_auto_unroll_max_step": 512, "pragma_unroll_explicit": 1}):
            for tx in T.thread_binding(T.int64(64), thread="threadIdx.x"):
                for i0_3_init, i1_3_init in T.grid(T.int64(8), T.int64(4)):
                    with T.block("matmul_init"):
                        v_i0 = T.axis.spatial(T.int64(2048), bx // T.int64(64) * T.int64(32) + tx // T.int64(16) * T.int64(8) + i0_3_init)
                        v_i1 = T.axis.spatial(T.int64(4096), bx % T.int64(64) * T.int64(64) + tx % T.int64(16) * T.int64(4) + i1_3_init)
                        T.reads()
                        T.writes(O_intermediate_local[v_i0, v_i1])
                        O_intermediate_local[v_i0, v_i1] = T.float32(0)
                for k_0 in range(T.int64(512)):
                    for tx in T.thread_binding(T.int64(64), thread="threadIdx.x"):
                        for ax0_ax1_fused_1 in T.vectorized(T.int64(4)):
                            with T.block("A_shared"):
                                v0 = T.axis.spatial(T.int64(2048), bx // T.int64(64) * T.int64(32) + (tx * T.int64(4) + ax0_ax1_fused_1) // T.int64(8))
                                v1 = T.axis.spatial(T.int64(4096), k_0 * T.int64(8) + (tx * T.int64(4) + ax0_ax1_fused_1) % T.int64(8))
                                T.reads(A[v0, v1])
                    ...
                    #     for tx in T.thread_binding(T.int64(64), thread="threadIdx.x"):
                    #         with T.block("A_shared"):
                    #             v0 = T.axis.spatial(T.int64(2048), bx // T.int64(64) * T.int64(32) + (ax0_ax1_fused_0 * T.int64(64) + tx) // T.int64(8))
                    #             v1 = T.axis.spatial(T.int64(4096), k_0 * T.int64(8) + (ax0_ax1_fused_0 * T.int64(64) + tx) % T.int64(8))
                    #             T.reads(A[v0, v1])
                    #             T.writes(A_shared[v0, v1])
                    #             A_shared[v0, v1] = A[v0, v1]
                        ...
                        for tx in T.thread_binding(T.int64(64), thread="threadIdx.x"):
                            for ax0_ax1_fused_2 in T.vectorized(T.int64(4)):
                                with T.block("B_shared"):
                                    v0 = T.axis.spatial(T.int64(4096), k_0 * T.int64(8) + (ax0_ax1_fused_0 * T.int64(256) + tx * T.int64(4) + ax0_ax1_fused_2) // T.int64(64))
                                    v1 = T.axis.spatial(T.int64(4096), bx % T.int64(64) * T.int64(64) + (ax0_ax1_fused_0 * T.int64(256) + tx * T.int64(4) + ax0_ax1_fused_2) % T.int64(64))
                                    T.reads(B[v0, v1])
                                    T.writes(B_shared[v0, v1])
                                    B_shared[v0, v1] = B[v0, v1]
                    for k_1, i0_3, i1_3, k_2, i0_4, i1_4 in T.grid(T.int64(1), T.int64(8), T.int64(1), T.int64(8), T.int64(1), T.int64(4)):
                        with T.block("matmul_update"):
                            v_i0 = T.axis.spatial(T.int64(2048), bx // T.int64(64) * T.int64(32) + tx // T.int64(16) * T.int64(8) + i0_3 + i0_4)
                            v_i1 = T.axis.spatial(T.int64(4096), bx % T.int64(64) * T.int64(64) + tx % T.int64(16) * T.int64(4) + i1_3 * T.int64(4) + i1_4)
                ...
                for ax0, ax1 in T.grid(T.int64(8), T.int64(4)):
                    with T.block("O_intermediate_local"):
                        v0 = T.axis.spatial(T.int64(2048), bx // T.int64(64) * T.int64(32) + tx // T.int64(16) * T.int64(8) + ax0)
                        v1 = T.axis.spatial(T.int64(4096), bx % T.int64(64) * T.int64(64) + tx % T.int64(16) * T.int64(4) + ax1)
