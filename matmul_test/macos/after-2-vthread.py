...
class Module:
    ...
    def compute(B: T.Buffer((T.int64(4096), T.int64(4096)), "float16"), p_A: T.handle, p_O: T.handle):
        ...
        for ax0_ax2_0_fused in T.thread_binding(T.int64(64), thread="blockIdx.y"):
            for ax1_0 in T.thread_binding(b * T.int64(8), thread="blockIdx.x"):
                for ax2_1 in T.thread_binding(T.int64(2), thread="vthread.y"):
                    for ax1_1 in T.thread_binding(T.int64(2), thread="vthread.x"):
                                ...
                                for ax2_3_init, ax1_3_0_init in T.grid(T.int64(4), T.int64(4)):
                                    for ax1_3_1_init in T.vectorized(T.int64(1)):
                                        with T.block("matmul_init"):
                                            ...
                                            v1 = T.axis.spatial(b * T.int64(512), ax1_0 * T.int64(64) + ax1_1 * T.int64(32) + ax1_2 * T.int64(4) + ax1_3_0_init + ax1_3_1_init)
                                            v2 = T.axis.spatial(T.int64(4096), ax0_ax2_0_fused * T.int64(64) + ax2_1 * T.int64(32) + ax2_2 * T.int64(4) + ax2_3_init)
                                            T.reads()
                                ...
                                for ax3_0, ax3_1, ax2_3, ax1_3_0 in T.grid(T.int64(512), T.int64(8), T.int64(4), T.int64(4)):
                                    for ax1_3_1 in T.vectorized(T.int64(1)):
                                        with T.block("matmul_update"):
                                            v0 = T.axis.spatial(T.int64(1), T.int64(0))
                                            v1 = T.axis.spatial(b * T.int64(512), ax1_0 * T.int64(64) + ax1_1 * T.int64(32) + ax1_2 * T.int64(4) + ax1_3_0 + ax1_3_1)
                                            v2 = T.axis.spatial(T.int64(4096), ax0_ax2_0_fused * T.int64(64) + ax2_1 * T.int64(32) + ax2_2 * T.int64(4) + ax2_3)
                                ...
                                for ax0, ax1, ax2_0 in T.grid(T.int64(1), T.int64(4), T.int64(4)):
                                    for ax2_1_1 in T.vectorized(T.int64(1)):
                                        with T.block("O_intermediate_reindex_local"):
                                            ...
                                            v1 = T.axis.spatial(b * T.int64(512), ax1_0 * T.int64(64) + ax1_1 * T.int64(32) + ax1_2 * T.int64(4) + ax1)
                                            v2 = T.axis.spatial(T.int64(4096), ax0_ax2_0_fused * T.int64(64) + ax2_1 * T.int64(32) + ax2_2 * T.int64(4) + ax2_0 + ax2_1_1)
