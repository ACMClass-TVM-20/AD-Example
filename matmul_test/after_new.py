                        ...
                        for ax1_1 in T.thread_binding(T.int64(4), thread="threadIdx.y"):
                            for ax2_1 in range(T.int64(4)):
                                with T.block("p_output0_intermediate_reindex_shared.dyn_warp_o"):
                                    ...
                                    p_output0_intermediate_reindex_shared_dyn_1 = T.Buffer((T.int64(1), T.int64(3072), T.int64(11008)), data=p_output0_intermediate_reindex_shared_dyn.data, scope="shared.dyn")
                                    T.writes(p_output0_intermediate_reindex_shared_dyn_1[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                    C_warp = T.match_buffer(p_output0_intermediate_reindex_shared_dyn_warp[v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), scope="warp", offset_factor=1)
                                    C = T.match_buffer(p_output0_intermediate_reindex_shared_dyn_1[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), strides=("C_s0", "C_s1"), scope="shared.dyn", offset_factor=1)
                                    tx = T.launch_thread("threadIdx.x", 32)
