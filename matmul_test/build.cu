...
extern "C" __global__ void __launch_bounds__(128) default_function_kernel(half* __restrict__ A, half* __restrict__ B, half* __restrict__ compute) {
  ...
  for (int ax3_0_0 = 0; ax3_0_0 < 4; ++ax3_0_0) {
    ...
    for (int ax0_ax1_fused_0 = 0; ax0_ax1_fused_0 < 4; ++ax0_ax1_fused_0) {
      *(uint4*)(((half*)buf_dyn_shmem) + (((((((ax0_ax1_fused_0 * 1536) + (((int)threadIdx.z) * 768)) + (((((int)threadIdx.x) & 3) >> 1) * 384)) + (((int)threadIdx.y) * 192)) + ((((int)threadIdx.x) >> 2) * 24)) + ((((int)threadIdx.x) & 1) * 8)) + 6144)) = *(uint4*)(A + ((((((((((int)blockIdx.x) >> 5) * 16384) + (ax0_ax1_fused_0 * 4096)) + (((int)threadIdx.z) * 2048)) + (((int)threadIdx.y) * 1024)) + ((((int)threadIdx.x) >> 2) * 128)) + (ax3_0_0 * 32)) + ((((int)threadIdx.x) & 3) * 8)));
    }
    for (int ax0_ax1_fused_0_1 = 0; ax0_ax1_fused_0_1 < 4; ++ax0_ax1_fused_0_1) {
      *(uint4*)(((half*)buf_dyn_shmem) + ((((((ax0_ax1_fused_0_1 * 1536) + (((int)threadIdx.z) * 768)) + (((((int)threadIdx.x) & 3) >> 1) * 384)) + (((int)threadIdx.y) * 192)) + ((((int)threadIdx.x) >> 2) * 24)) + ((((int)threadIdx.x) & 1) * 8))) = *(uint4*)(B + ((((((((((int)blockIdx.x) & 31) * 16384) + (ax0_ax1_fused_0_1 * 4096)) + (((int)threadIdx.z) * 2048)) + (((int)threadIdx.y) * 1024)) + ((((int)threadIdx.x) >> 2) * 128)) + (ax3_0_0 * 32)) + ((((int)threadIdx.x) & 3) * 8)));
    }
    __syncthreads();
