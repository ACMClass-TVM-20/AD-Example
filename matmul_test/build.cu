...
;
  ...
  for (int ax3_0_0 = 0; ax3_0_0 < 128; ++ax3_0_0) {
    ...
    for (int ax0_ax1_fused_0 = 0; ax0_ax1_fused_0 < 4; ++ax0_ax1_fused_0) {
      *(uint4*)(((half*)buf_dyn_shmem) + (((((ax0_ax1_fused_0 * 1024) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 256)) + (((int)threadIdx.x) * 8)) + 4096)) = *(uint4*)(A + ((((((((((int)blockIdx.x) >> 5) * 524288) + (ax0_ax1_fused_0 * 131072)) + (((int)threadIdx.z) * 65536)) + (((int)threadIdx.y) * 32768)) + ((((int)threadIdx.x) >> 2) * 4096)) + (ax3_0_0 * 32)) + ((((int)threadIdx.x) & 3) * 8)));
    }
    for (int ax0_ax1_fused_0_1 = 0; ax0_ax1_fused_0_1 < 4; ++ax0_ax1_fused_0_1) {
      *(uint4*)(((half*)buf_dyn_shmem) + ((((ax0_ax1_fused_0_1 * 1024) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 256)) + (((int)threadIdx.x) * 8))) = *(uint4*)(B + ((((((((((int)blockIdx.x) & 31) * 524288) + (ax0_ax1_fused_0_1 * 131072)) + (((int)threadIdx.z) * 65536)) + (((int)threadIdx.y) * 32768)) + ((((int)threadIdx.x) >> 2) * 4096)) + (ax3_0_0 * 32)) + ((((int)threadIdx.x) & 3) * 8)));
    }
    __syncthreads();
  ...
  {
    unsigned int addr = cast_smem_ptr_to_int((&(((half*)buf_dyn_shmem)[((((((int)threadIdx.z) * 2048) + (ax0_0 * 512)) + (ax3_0_1 * 16)) + 4096)])) + (((((int)threadIdx.x) & 15) * 32) + ((((int)threadIdx.x) >> 4) * 8)));
...
;
  ...
  for (int ax0_ax1_fused_0_2 = 0; ax0_ax1_fused_0_2 < 16; ++ax0_ax1_fused_0_2) {
    uint4 __1;
    ulonglong4 v_ = *(ulonglong4*)(((float*)buf_dyn_shmem) + ((((ax0_ax1_fused_0_2 * 1024) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 256)) + (((int)threadIdx.x) * 8)));
    ...
    *(uint4*)(compute + ((((((((((int)blockIdx.x) >> 5) * 524288) + (ax0_ax1_fused_0_2 * 32768)) + (((int)threadIdx.z) * 16384)) + (((int)threadIdx.y) * 8192)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.x) & 31) * 128)) + ((((int)threadIdx.x) & 15) * 8))) = __1;
  }
}
