    ...
    def fused_fused_decode3_fused_NT_matmul21_cast21_add5_silu2(
        ...
        for i, j in T.grid(T.int64(4096), T.int64(4096)):
            with T.block("decode"):
                ...
                B_intermediate[v_i, v_j] = (
                    T.Cast(
                        "float16",
                        T.bitwise_and(
                            T.shift_right(
                                data[v_i, v_j // T.int64(8)],
        ...
        for i0, i1, i2, k in T.grid(b, T.int64(512), T.int64(4096), T.int64(4096)):
            with T.block("NT_matmul"):
                ...
                O_intermediate[v_i0, v_i1, v_i2] = O_intermediate[v_i0, v_i1, v_i2] + T.Cast(
                    "float32", A[v_i0, v_i1, v_k]
                ) * T.Cast("float32", B_intermediate[v_i2, v_k])
...
inputs = [
    ...
    # torch.zeros(b, s, 4096, dtype=torch.float16).cuda(),
]
