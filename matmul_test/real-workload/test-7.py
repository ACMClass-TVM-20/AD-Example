...
class Module:
    ...
    @R.function
    def main(
        x: R.Tensor(("b", 128, 128), "float16"),
        y: R.Tensor((128, 128), "float16"),
    ):
        cls = Module
        b = T.int64()
        out = R.call_tir(
...
# inputs_torch = [
#     torch.randn(b, 128, 128, dtype=torch.float16).cuda(),
#     torch.randn(128, 128, dtype=torch.float16).cuda(),
# ]
...
# tflops = b * 128 * 128 * 128 * 2 / operator_tm / 1e6
