...
class Module:
    ...
    def fused_fused_decode3_fused_NT_matmul21_cast21_add5_silu2(lv2608: T.Buffer((T.int64(11008), T.int64(512)), "uint32"), lv2609: T.Buffer((T.int64(11008), T.int64(128)), "float16"), p_lv7330: T.handle, p_output0: T.handle):
        ...
        lv2608_shared_dyn = T.alloc_buffer((T.int64(11008), T.int64(512)), "uint32", scope="shared.dyn")
        lv2609_shared_dyn = T.alloc_buffer((T.int64(11008), T.int64(128)), "float16", scope="shared.dyn")
        ...
        for ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused in T.thread_binding(b * T.int64(344), thread="blockIdx.x"):
            ...
            for ax3_0_0 in T.serial(T.int64(128), annotations={"software_pipeline_async_stages": [0], "software_pipeline_order": [0, 1, 2, 3, 4], "software_pipeline_stage": [0, 0, 0, 3, 3]}):
                ...
                for ax0_0 in range(T.int64(1)):
                    for ax0_1 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                        for ax0_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                            for ax0_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax1 in T.vectorized(T.int64(4)):
                                    with T.block("lv2608_shared.dyn"):
                                        v0 = T.axis.spatial(T.int64(11008), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused % T.int64(86) * T.int64(128) + ax0_0 * T.int64(128) + ax0_1 * T.int64(64) + ax0_2 * T.int64(32) + ax0_3)
                                        v1 = T.axis.spatial(T.int64(512), ax3_0_0 * T.int64(4) + ax1)
                                        T.reads(lv2608[v0, v1])
                                        T.writes(lv2608_shared_dyn[v0, v1])
                                        lv2608_shared_dyn[v0, v1] = lv2608[v0, v1]
                for ax0_0 in range(T.int64(1)):
                    for ax0_1 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                        for ax0_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                            for ax0_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                with T.block("lv2609_shared.dyn"):
                                    v0 = T.axis.spatial(T.int64(11008), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused % T.int64(86) * T.int64(128) + ax0_0 * T.int64(128) + ax0_1 * T.int64(64) + ax0_2 * T.int64(32) + ax0_3)
                                    v1 = T.axis.spatial(T.int64(128), ax3_0_0)
                                    T.reads(lv2609[v0, v1])
                                    T.writes(lv2609_shared_dyn[v0, v1])
                                    lv2609_shared_dyn[v0, v1] = lv2609[v0, v1]
                for ax0_ax1_fused_0 in range(T.int64(8)):
                    for ax0_ax1_fused_1 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                        for ax0_ax1_fused_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                            for ax0_ax1_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_4 in T.vectorized(T.int64(4)):
                                    with T.block("p_output0_intermediate_1_reindex_reindex"):
                                        v0 = T.axis.spatial(T.int64(11008), ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused % T.int64(86) * T.int64(128) + (ax0_ax1_fused_0 * T.int64(512) + ax0_ax1_fused_1 * T.int64(256) + ax0_ax1_fused_2 * T.int64(128) + ax0_ax1_fused_3 * T.int64(4) + ax0_ax1_fused_4) // T.int64(32))
                                        v1 = T.axis.spatial(T.int64(4096), ax3_0_0 * T.int64(32) + (ax0_ax1_fused_0 * T.int64(512) + ax0_ax1_fused_1 * T.int64(256) + ax0_ax1_fused_2 * T.int64(128) + ax0_ax1_fused_3 * T.int64(4) + ax0_ax1_fused_4) % T.int64(32))
                                        T.reads(lv2608_shared_dyn[v0, v1 // T.int64(8)], lv2609_shared_dyn[v0, v1 // T.int64(32)])
                                        T.writes(p_output0_intermediate_1_reindex_shared_dyn[T.int64(0), v0, v1])
                                        T.block_attr({"permuted_layout": "g2s_B"})
                                        p_output0_intermediate_1_reindex_shared_dyn[T.int64(0), v0, v1] = (T.Cast("float16", T.bitwise_and(T.shift_right(lv2608_shared_dyn[v0, v1 // T.int64(8)], T.Cast("uint32", v1 % T.int64(8)) * T.uint32(4)), T.uint32(15))) - T.float16(7)) * lv2609_shared_dyn[v0, v1 // T.int64(32)]
    ...
    def main(w1: R.Tensor((11008, 512), dtype="uint32"), w2: R.Tensor((11008, 128), dtype="float16"), x: R.Tensor(("b", 512, 4096), dtype="float16")) -> R.Tensor(("b", 512, 11008), dtype="float16"):
        b = T.int64()
        cls = Module
        out = R.call_tir(cls.fused_fused_decode3_fused_NT_matmul21_cast21_add5_silu2, (w1, w2, x), out_sinfo=R.Tensor((b, 512, 11008), dtype="float16"))
        return out
