...
class Module:
    @T.prim_func
    def fused_fused_decode4_transpose5_fused_NT_matmul21_cast21(lv4075: T.Buffer((T.int64(4096), T.int64(1376)), "uint32"), lv4076: T.Buffer((T.int64(4096), T.int64(344)), "float16"), p_lv10517_adjoint: T.handle, p_output0: T.handle, var_decode_intermediate: T.Buffer((T.int64(4096), T.int64(11008)), "float16")):
        ...
        # with T.block("root"):
        lv10517_adjoint_reindex_shared_dyn = T.alloc_buffer((b, T.int64(512), T.int64(4096)), "float16", scope="shared.dyn")
        lv10517_adjoint_reindex_shared_dyn_warp = T.alloc_buffer((b, T.int64(32), T.int64(256), T.int64(32), T.int64(8)), "float16", scope="warp")
            ...
            for i_j_fused_1 in T.thread_binding(T.int64(128), thread="threadIdx.x"):
                for i_j_fused_2 in T.unroll(T.int64(2)):
                    for i_j_fused_3 in T.vectorized(T.int64(4)):
                        with T.block("decode"):
                            v_i = T.axis.spatial(T.int64(4096), (i_j_fused_0 * T.int64(1024) + i_j_fused_1 * T.int64(8) + i_j_fused_2 * T.int64(4) + i_j_fused_3) // T.int64(11008))
                            v_j = T.axis.spatial(T.int64(11008), (i_j_fused_0 * T.int64(1024) + i_j_fused_1 * T.int64(8) + i_j_fused_2 * T.int64(4) + i_j_fused_3) % T.int64(11008))
                        ...
                        for ax0_ax1_fused_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                            for ax0_ax1_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_4 in T.vectorized(T.int64(8)):
                                    with T.block("lv10517_adjoint_reindex_shared.dyn"):
                                        ...
                                        T.reads(lv10517_adjoint[v0, v1, v2])
                                        T.writes(lv10517_adjoint_reindex_shared_dyn[v0, v1, v2])
                                        lv10517_adjoint_reindex_shared_dyn[v0, v1, v2] = lv10517_adjoint[v0, v1, v2]
                for ax0_ax1_fused_0 in range(T.int64(4)):
                    for ax0_ax1_fused_1 in T.thread_binding(T.int64(2), thread="threadIdx.z"):
                        for ax0_ax1_fused_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                            for ax0_ax1_fused_3 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_4 in T.vectorized(T.int64(8)):
                                    with T.block("p_output0_intermediate_1_reindex_shared.dyn"):
                                        ...
                                        v2 = T.axis.spatial(T.int64(4096), ax3_0_0 * T.int64(32) + (ax0_ax1_fused_0 * T.int64(1024) + ax0_ax1_fused_1 * T.int64(512) + ax0_ax1_fused_2 * T.int64(256) + ax0_ax1_fused_3 * T.int64(8) + ax0_ax1_fused_4) % T.int64(32))
                                        T.reads(var_decode_intermediate[v2, v1])
                                        T.writes(p_output0_intermediate_1_reindex_shared_dyn[v0, v1, v2])
                                        p_output0_intermediate_1_reindex_shared_dyn[v0, v1, v2] = var_decode_intermediate[v2, v1]
                    ...
                    for ax2_0_2 in T.thread_binding(T.int64(2), thread="threadIdx.y"):
                        for ax3_0_1 in range(T.int64(2)):
                            for ax0_0 in range(T.int64(4)):
                                with T.block("lv10517_adjoint_reindex_shared.dyn_warp_o"):
                                    v0_o = T.axis.spatial(b, ax0_ax1_0_0_ax2_0_0_ax1_0_1_ax2_0_1_fused // T.int64(344))
                                    ...
                                    T.reads(lv10517_adjoint_reindex_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                    T.writes(lv10517_adjoint_reindex_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                    with T.block("lv10517_adjoint_reindex_shared.dyn_warp_o"):
                                        v1_i_o = T.axis.spatial(T.int64(1), T.int64(0))
                                        v2_i_o = T.axis.spatial(T.int64(1), T.int64(0))
                                        T.reads(lv10517_adjoint_reindex_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                        T.writes(lv10517_adjoint_reindex_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                        warp = T.match_buffer(lv10517_adjoint_reindex_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), "float16", scope="warp", offset_factor=16)
                                        shared = T.match_buffer(lv10517_adjoint_reindex_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("shared_s0", "shared_s1"), scope="shared.dyn", offset_factor=16)
                                        for tx in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                            ...
                            for ax1_0_3, ax2_0_3 in T.grid(T.int64(4), T.int64(4)):
                                with T.block("NT_matmul_o_update"):
                                    ...
                                    with T.block("NT_matmul_o"):
                                        ...
                                        T.reads(var_NT_matmul_intermediate_reindex_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], lv10517_adjoint_reindex_shared_dyn_warp[v0_o, v1_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], p_output0_intermediate_1_reindex_shared_dyn_warp[T.int64(0), v2_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                        T.writes(var_NT_matmul_intermediate_reindex_shared_dyn_warp[v0_o, v1_o, v2_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)])
                                        A = T.match_buffer(lv10517_adjoint_reindex_shared_dyn_warp[v0_o, v1_o, v3_o, T.int64(0):T.int64(32), T.int64(0):T.int64(8)], (T.int64(32), T.int64(8)), "float16", scope="warp", offset_factor=16)
    ...
    @R.function
    def main(w1: R.Tensor((4096, 1376), dtype="uint32"), w2: R.Tensor((4096, 344), dtype="float16"), x: R.Tensor(("b", 512, 4096), dtype="float16")) -> R.Tensor(("b", 512, 11008), dtype="float16"):
        b = T.int64()
        cls = Module
        gv = R.call_tir(cls.fused_fused_decode4_transpose5_fused_NT_matmul21_cast21, (w1, w2, x), out_sinfo=[R.Tensor((b, 512, 11008), dtype="float16"), R.Tensor((4096, 11008), dtype="float16")])
