...
inputs = [torch.randn(1, m, 4096, dtype=torch.float16), torch.randn(4096, 4096, dtype=torch.float16), torch.zeros(1, m, 4096, dtype=torch.float16)]
tvm_inputs = [tvm.nd.array(x, dev) for x in inputs]
ex(*tvm_inputs)
